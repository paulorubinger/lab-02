...
def clone_repository(repo_url, repo_name, index, max_repos):
...
def clone_repositories(file_path, max_repos=5):
    ...
    with open(file_path, newline="", encoding="utf-8") as file:
        ...
        for i, repo in enumerate(reader, start=1):
            ...
            clone_repository(repo_url, repo_name, i, max_repos)

if __name__ == "__main__":
    clone_repositories("data/raw/repositories.csv", max_repos=2)